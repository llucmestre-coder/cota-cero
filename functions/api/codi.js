...
const TEXTOS = {
  es: {
    assumpte: 'Tu código para ver la estimación · Cota Cero Reformas',
    intro: 'Este es tu código para ver la estimación de tu reforma:',
    caduca: 'Caduca en 10 minutos. Si no lo has pedido tú, ignora este correo.',
  },
  ca: {
    assumpte: 'El teu codi per veure l\'estimació · Cota Cero Reformas',
    intro: 'Aquest és el teu codi per veure l\'estimació de la teva reforma:',
    caduca: 'Caduca d\'aquí a 10 minuts. Si no l\'has demanat tu, ignora aquest correu.',
  },
  en: {
    assumpte: 'Your code to see the estimate · Cota Cero Reformas',
    intro: 'This is your code to see the estimate for your renovation:',
...
export async function onRequestPost({ request, env }) {
  ...
  const html = `<div style="font-family:Arial,sans-serif;color:#22262A;max-width:480px">
  <p style="font-size:16px">${t.intro}</p>
  <p style="font-size:34px;font-weight:700;letter-spacing:6px;margin:16px 0">${codi}</p>
  <p style="font-size:14px;color:#5F6661">${t.caduca}</p>
  <p style="font-size:14px;color:#5F6661">Cota Cero Reformas</p></div>`;
